...
typedef enum _MessageType {
    ...
    MessageType_MessageType_U2FInit = 200,
    MessageType_MessageType_U2FGetCounter = 201,
    MessageType_MessageType_U2FCounter = 202,
    MessageType_MessageType_U2FSetEntry = 203
} MessageType;
...
typedef struct {
    size_t size;
    uint8_t bytes[32];
} U2FInit_u2f_attestation_key_t;

typedef struct {
    size_t size;
    uint8_t bytes[500];
} U2FInit_u2f_attestation_cert_t;

typedef struct _U2FInit {
    U2FInit_u2f_attestation_key_t u2f_attestation_key;
    U2FInit_u2f_attestation_cert_t u2f_attestation_cert;
    uint32_t u2f_counter;
} U2FInit;

typedef struct _U2FSetEntry {
    char uri[512];
    char name[20];
} U2FSetEntry;
...
#define U2FInit_init_default                     {{0, {0}}, {0, {0}}, 0}
#define U2FGetCounter_init_default               {0}
#define U2FCounter_init_default                  {0}
#define U2FSetEntry_init_default                 {"", ""}
...
#define U2FInit_init_zero                        {{0, {0}}, {0, {0}}, 0}
#define U2FGetCounter_init_zero                  {0}
#define U2FCounter_init_zero                     {0}
#define U2FSetEntry_init_zero                    {"", ""}
...
#define U2FCounter_u2f_counter_tag               1
#define U2FInit_u2f_attestation_key_tag          1
#define U2FInit_u2f_attestation_cert_tag         2
#define U2FInit_u2f_counter_tag                  3
#define U2FSetEntry_uri_tag                      1
#define U2FSetEntry_name_tag                     2
...
extern const pb_field_t U2FInit_fields[4];
extern const pb_field_t U2FGetCounter_fields[1];
extern const pb_field_t U2FCounter_fields[2];
extern const pb_field_t U2FSetEntry_fields[3];
...
#define U2FInit_size                             543
#define U2FGetCounter_size                       0
#define U2FCounter_size                          6
#define U2FSetEntry_size                         537
