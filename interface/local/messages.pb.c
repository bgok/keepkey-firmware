...
const pb_field_t U2FInit_fields[4] = {
    PB_FIELD2(  1, BYTES   , REQUIRED, STATIC  , FIRST, U2FInit, u2f_attestation_key, u2f_attestation_key, 0),
    PB_FIELD2(  2, BYTES   , REQUIRED, STATIC  , OTHER, U2FInit, u2f_attestation_cert, u2f_attestation_key, 0),
    PB_FIELD2(  3, UINT32  , REQUIRED, STATIC  , OTHER, U2FInit, u2f_counter, u2f_attestation_cert, 0),
    PB_LAST_FIELD
};

const pb_field_t U2FGetCounter_fields[1] = {
    PB_LAST_FIELD
};

const pb_field_t U2FCounter_fields[2] = {
    PB_FIELD2(  1, UINT32  , REQUIRED, STATIC  , FIRST, U2FCounter, u2f_counter, u2f_counter, 0),
    PB_LAST_FIELD
};

const pb_field_t U2FSetEntry_fields[3] = {
    PB_FIELD2(  1, STRING  , REQUIRED, STATIC  , FIRST, U2FSetEntry, uri, uri, 0),
    PB_FIELD2(  2, STRING  , REQUIRED, STATIC  , OTHER, U2FSetEntry, name, uri, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
STATIC_ASSERT((pb_membersize(Features, coins[0]) < 65536 && pb_membersize(PublicKey, node) < 65536 && pb_membersize(GetAddress, multisig) < 65536 && pb_membersize(LoadDevice, node) < 65536 && pb_membersize(SimpleSignTx, inputs[0]) < 65536 && pb_membersize(SimpleSignTx, outputs[0]) < 65536 && pb_membersize(SimpleSignTx, transactions[0]) < 65536 && pb_membersize(TxRequest, details) < 65536 && pb_membersize(TxRequest, serialized) < 65536 && pb_membersize(TxAck, tx) < 65536 && pb_membersize(SignIdentity, identity) < 65536 && pb_membersize(DebugLinkState, node) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Initialize_GetFeatures_Features_ClearSession_ApplySettings_ChangePin_Ping_Success_Failure_ButtonRequest_ButtonAck_PinMatrixRequest_PinMatrixAck_Cancel_PassphraseRequest_PassphraseAck_GetEntropy_Entropy_GetPublicKey_PublicKey_GetAddress_Address_WipeDevice_LoadDevice_ResetDevice_EntropyRequest_EntropyAck_RecoveryDevice_WordRequest_WordAck_CharacterRequest_CharacterAck_SignMessage_VerifyMessage_MessageSignature_EncryptMessage_EncryptedMessage_DecryptMessage_DecryptedMessage_CipherKeyValue_CipheredKeyValue_EstimateTxSize_TxSize_SignTx_SimpleSignTx_TxRequest_TxAck_SignIdentity_SignedIdentity_FirmwareErase_FirmwareUpload_DebugLinkDecision_DebugLinkGetState_DebugLinkState_DebugLinkStop_DebugLinkLog_DebugLinkFillConfig_U2FInit_U2FGetCounter_U2FCounter_U2FSetEntry)
#endif
