...
const pb_field_t Storage_fields[13] = {
    ...
    PB_FIELD2( 10, BYTES   , OPTIONAL, STATIC  , OTHER, Storage, u2f_attestation_key, imported, 0),
    PB_FIELD2( 11, BYTES   , OPTIONAL, STATIC  , OTHER, Storage, u2f_attestation_cert, u2f_attestation_key, 0),
    PB_FIELD2( 12, UINT32  , OPTIONAL, STATIC  , OTHER, Storage, u2f_counter, u2f_attestation_cert, 0),
    PB_LAST_FIELD
};
...
#error Field descriptor for Storage.u2f_attestation_cert is too large. Define PB_FIELD_16BIT to fix this.
#endif
